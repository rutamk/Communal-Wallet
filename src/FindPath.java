...
public class FindPath {
     ...
     *
     * @param details A map where the key is a friend's name and the value is their balance.
     *                Positive values indicate amounts owed to the friend, negative values indicate
    ...
    public static void findPath(HashMap<String, Double> details) {
        ...
        if (!maxBalance.equals(minBalance)) {
            ...
            if (result >= 0.0) {
                // If result is non-negative: minKey needs to pay maxKey the absolute value of minBalance
                ...
                // If result is negative: minKey needs to pay maxKey the absolute value of maxBalance
    ...
    public static double round(double value, int places) {
        if (places < 0) throw new IllegalArgumentException();  // Ensure places is non-negative
